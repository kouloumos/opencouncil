                ...
                <div className="space-y-2">
                    ...
                    {preferences.length > 0 && (
                        <p className="text-xs text-muted-foreground">
                            {t('lastUpdated', { date: format(new Date(Math.max(...preferences.map(p => new Date(p.updatedAt).getTime()))), 'dd/MM/yyyy HH:mm', { locale: el }) })}
                        </p>
                    )}
                </div>
                                            ...
                                            <TableRow key={notification.id}>
                                                <TableCell>
                                                    <div className="space-y-1">
                                                        ...
                                                        <p className="text-xs text-muted-foreground">
                                                            {t('dateLabel')} {format(new Date(notification.createdAt), 'dd/MM/yyyy', { locale: el })}
                                                        </p>
                                        ...
                                        return (
                                            <TableRow key={notification.id}>
                                                ...
                                                <TableCell className="text-xs text-muted-foreground whitespace-nowrap">
                                                    {format(new Date(notification.createdAt), 'dd/MM/yyyy', { locale: el })}
                                                </TableCell>
                                                <TableCell className="text-right">
